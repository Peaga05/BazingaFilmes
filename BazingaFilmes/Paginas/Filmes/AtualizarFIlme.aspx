<%@ Page Title="Atualizar Filme" Language="C#" MasterPageFile="~/SiteCrud.Master" AutoEventWireup="true" CodeBehind="AtualizarFIlme.aspx.cs" Inherits="BazingaFilmes.Paginas.Filmes.AtualizarFIlme" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <h1 id="title" class="text-center mt-5">Atualizar Filme</h1>
    <div class="container">
    ...
    <div class=" mt-3 m-auto  text-center">
        ...
        <asp:Button ID="btnAtualizar" class="btn btn-outline-warning w-25 btn-default" Text="Atualizar" OnClick="btnAtualizar_Click" runat="server" />  
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-4 mt-3 mb-3">
